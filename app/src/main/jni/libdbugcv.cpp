...
void drawFrameProcOCLOCV() {
 ...
 Java_com_team3316_bugeyed_DBugNativeBridge_drawFrame(JNIEnv *env, jclass type) {
    LOGD("*** drawFrame() ***");
    int64_t t = getTimeMs();
...
void closeCL();
extern "C" JNIEXPORT void JNICALL
Java_com_team3316_bugeyed_DBugNativeBridge_closeGL(JNIEnv *env, jclass type) {
    closeCL();
    LOGD("closeGL");
    deleteTex(&texOES);
...
Java_com_team3316_bugeyed_DBugNativeBridge_initGL(JNIEnv *env, jclass type) {
    LOGD("initGL");

    Java_com_team3316_bugeyed_DBugNativeBridge_closeGL(env, type);
...
extern "C" JNIEXPORT void JNICALL
Java_com_team3316_bugeyed_DBugNativeBridge_changeSize(JNIEnv *env, jclass type, jint width, jint height) {
