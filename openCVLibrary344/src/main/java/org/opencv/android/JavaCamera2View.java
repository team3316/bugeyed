...
//                                    CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_PICTURE);
                            ...
                            // Turning off autofocus, auto exposure, auto white balance
...
//                            mPreviewRequestBuilder.set(CaptureRequest.SENSOR_SENSITIVITY, 3200);
    ...
    */
    ...
    /*
     * MARK - OpenCV Fix #1
     * This is a custom implementation done by us, in order to
     * fix this: https://github.com/opencv/opencv/issues/11261.
     * These constants are specific to the device we use on the
     * robot (OnePlus 2).
     */
    boolean calcPreviewSize(final int width, final int height) {
        int bestWidth = 640, bestHeight = 320;
        if (mPreviewSize.getWidth() == bestWidth && mPreviewSize.getHeight() == bestHeight) {
            return false;
        } else {
    ...
    private class JavaCamera2Frame implements CvCameraViewFrame {
        ...
        /*
         * Fix for OnePlus 2:
         * COLOR_YUV2RGBA_NV21 -> COLOR_YUV2RGBA_NV12
         */
        @Override
        public Mat rgba() {
